...
<head>
    ...
    <script src="${path}/static/jss/注册.js"></script>
    <style>
        .tab {
            overflow: hidden;
            margin-top: 20px;
    ...
    <div class="loginbox">
        ...
        <div class="conlist">
            <div class="conbox" style="display:block;">
                ...
                <div><input type="text" class="loginuser" id="username" name="user_username"></div>
                <span id="usernamespan"></span>
                </p>
                <p>
                <div class="fl res-text">密码：</div>
                <div><input type="password" class="loginuser" id="password" name="user_password"></div>
                <span id="passwordspan"></span>
                </p>
                <p>
                <div class="fl res-text">确认密码：</div>
                <div><input type="password" class="loginuser" id="password2" name="user_password2"></div>
                <span id="password2span"></span>
                </p>
                <p>
                <div class="fl res-text">验证码：</div>
                <div class="fl"><input type="text" class="loginuser2" id="auth" name="auth"></div>
                <span id="authspan"></span>
                <div class="fl same-code">获取验证码<img src="${path}/authImg"></div>
            ...
            <div class="conbox">
                <p>
                <div class="fl res-text">用户名：</div>
                <div><input type="text" class="loginuser"></div>
                </p>
                <p>
                <div class="fl res-text">密码：</div>
                <div><input type="password" class="loginuser"></div>
                </p>
                <p>
                <div class="fl res-text">确认密码：</div>
                <div><input type="password" class="loginuser"></div>
